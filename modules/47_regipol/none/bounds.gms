...
vm_deltaCap.fx("2025",regi,"pc","1") = 20 * 0.78 / 1e3;
vm_deltaCap.fx("2025",regi,"coalchp","1") = 20 * 0.22 / 1e3;
...
vm_deltaCap.fx("2030",regi,"pc","1") = 20 * 0.78 / 1e3;
vm_deltaCap.fx("2030",regi,"coalchp","1") = 20 * 0.22 / 1e3;

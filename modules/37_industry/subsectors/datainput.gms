...
$ifthen.cm_subsec_model_chemicals "%cm_subsec_model_chemicals%" == "processes"
p37_specMatDem("ammonia","FertProd","standard")        = 0.57; #TODOQZ Used to verify that the data are equal
...
!!TODO: Check sum over two chemicals electricity types!!
    ...
    loop((tePrc1,opmoPrc1,mat)$(
      ...
      p37_matFlowHist(ttot,regi,mat)
        = sum((tePrc2matOut(tePrc1,opmoPrc1,mat),
            ...
            p37_specMatDem(mat,tePrc2,opmoPrc2) * pm_outflowPrcHist(ttot,regi,tePrc2,opmoPrc2) ); #TODOQZ:: Used to verify that the data are equal

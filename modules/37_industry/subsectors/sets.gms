...
$endif.cm_subsec_model_steel
 ...
 fe_tax_sub37(all_in,all_in)   "correspondence between tax and subsidy input data resolution and model sectoral resolution"
  /
    fesoi . (feso_cement, feso_otherInd)
    fehoi . (feli_cement, feli_otherInd)
    fegai . (fega_cement, fega_otherInd)
    feh2i . (feh2_cement, feh2_otherInd)
    fehei . fehe_otherInd
    feeli . (feel_cement, feelhth_otherInd, feelwlth_otherInd)
$ifthen.cm_subsec_model_chemicals "%cm_subsec_model_chemicals%" == "ces"
    fesoi . feso_chemicals
    fehoi . feli_chemicals
    fegai . fega_chemicals
    feh2i . feh2_chemicals
    feeli . (feelhth_chemicals, feelwlth_chemicals)
$endif.cm_subsec_model_chemicals
$ifthen.cm_subsec_model_steel "%cm_subsec_model_steel%" == "ces"
    fesoi . feso_steel
    fehoi . feli_steel

...
*** cm_hydroTrade  "switch to turn on/off hydrogen trade between regions"
*** (off): no hydrogen trade between regions
...
*** switch to choose plastic MFA module activation
*** (off): plastic MFA module deactivated

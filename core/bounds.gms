...
***  vm_cap.lo("2010",regi,te,"1")$pm_histCap("2010",regi,te) = pm_histCap("2010",regi,te);
  ...
  vm_cap.lo("2020",regi,te,"1")$pm_histCap("2020",regi,te) = 0.7 * pm_histCap("2020",regi,te);
);
